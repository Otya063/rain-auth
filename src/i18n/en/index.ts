...
const en: BaseTranslation = {
    ...
    register: {
        ...
        doneRegister: 'Account creation and discord linking has been successfully completed.<br>You may close this page.',
    ...
    linkDiscord: {
        ...
        doneLinkDiscord: 'The discord account has been successfully linked.<br>You may close this page.',
        buttonLabel: 'Link',
